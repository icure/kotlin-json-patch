...
/*
 * Fixtures from the community JSON Patch test suite:
 * https://github.com/json-patch/json-patch-tests
 * Copyright 2014 The Authors. Licensed under the Apache License, Version 2.0.
 *
 * tests.json      -> TestData_JSON_PATCH_TESTS
 * spec_tests.json -> TestData_JSON_PATCH_SPEC_TESTS (examples from RFC 6902 Appendix A)
 *
 * Case format: { "comment", "doc", "patch", "expected" | "error", "disabled"? }
 */

const val TestData_JSON_PATCH_TESTS: String = """
[
...
const val TestData_JSON_PATCH_SPEC_TESTS: String = """
[
  {
